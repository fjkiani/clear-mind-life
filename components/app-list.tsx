...
export default function AppList() {
  const apps01 = [
    {
      name: "Identity Threat Scanner",
      description:
        "6-tier continuous Red-Team validation engine checking Auth, RBAC, and Compliance in real-time, neutralizing token theft before lateral movement occurs.",
      image: IntegrationImg01,
      link: "#0",
      badge: true,
    },
    {
      name: "Identity Hub (IDaaS)",
      description:
        "Autonomous role-based access orchestration that leverages dynamic agentic context—eliminating static JWTs and dropping the success rate of MFA prompt bombing to zero.",
      image: IntegrationImg02,
      link: "#0",
    },
    {
      name: "Clinical Receptionist AI",
      description:
        "An HL7/FHIR compliant intake orchestration agent that handles insurance verification, clinical triage scoring, and prior-authorization logic autonomously.",
      image: IntegrationImg03,
      link: "#0",
      badge: true,
    },
    {
      name: "Telehealth Post-Visit Analyzer",
      description:
        "Extracts structured insights from patient video feeds to automate FHIR charting and generate predictive follow-up protocols instantly.",
          ...
          <div className="space-y-10">
            ...
            <section>
              <div className="mb-5 flex items-center justify-between space-x-2">
                <h2 className="truncate text-xl font-bold">Core Engines</h2>
                <a
            ...
            <section>
              <div className="mb-5 flex items-center justify-between space-x-2">
                <h2 className="truncate text-xl font-bold">Infrastructure APIs</h2>
                <a
                  className="shrink-0 text-sm font-medium text-blue-500 transition hover:text-blue-600"
                  href="#0"
                >
