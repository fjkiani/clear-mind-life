...
const competitors: Competitor[] = [
  {
    ...
    verdict: 'Switch to eliminate kiosk maintenance and staff data-entry.'
  },
  {
    id: 'scribeamerica',
    name: 'ScribeAmerica & Offshore',
    category: 'Clinical Documentation',
    theirApproach: 'Human scribes (expensive, high turnover) or basic NLP dictation that still requires manual chart review and CPT coding.',
    ...
    verdict: 'Replace to reclaim 2+ hours daily and guarantee coding accuracy.'
  },
  {
    id: 'athena',
    name: 'Athena Collector & Rules',
    category: 'Revenue Cycle',
    theirApproach: 'Static rules engines that flag errors after they occur, requiring armies of billers to fix them through tedious exception queues.',
    ...
    verdict: 'Integrate alongside or replace to drop denial rates near zero.'
  },
  {
    id: 'waystar',
    name: 'Waystar & Clearinghouses',
    category: 'Claims Processing',
    theirApproach: 'Acts simply as a pipe. Receives clean claims and passes them through, but leaves the heavy lifting of scrubbing to your staff.',
    ...
    verdict: 'Merge functionality by letting Clear Mind act as your autonomous biller.'
  }
]
